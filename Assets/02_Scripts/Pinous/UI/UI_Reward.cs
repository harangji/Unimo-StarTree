    ...
    public void GetIAPReward(string name)
    {
        ...
        switch (name)
        {
            ...
            case "revemoads_all": 
                ...
                Main_UI.instance.RectADSCheck();
                break;
            case "bluehoney_1500": GetRewardInit(RewardState.Other, Asset_State.Blue, 200); break;
            // case "bluehoney_1500": GetRewardInit(RewardState.Other, CharCostumer.Charcater, 120, 0, 0); break;
            case "bluehoney_3300": GetRewardInit(RewardState.Other, Asset_State.Blue, 450); break;
            case "bluehoney_6900": GetRewardInit(RewardState.Other, Asset_State.Blue, 950); break;
            case "bluehoney_9900": GetRewardInit(RewardState.Other, Asset_State.Blue, 1400); break;
            case "bluehoney_29000": GetRewardInit(RewardState.Other, Asset_State.Blue, 4200); break;
            case "bluehoney_49000": GetRewardInit(RewardState.Other, Asset_State.Blue, 7200); break;
